...
<body>
	...
	<div id="rightContent">
		...
		<div class="shortcutHome">
			<a href="Manager/Uploadfile.jsp"><img src="images/photo.png"><br>Upload
				photo</a>
		</div>
		...
		<div id="smallRight">
			<h3>Your web information</h3>
			<table
				style="border: none; font-size: 12px; color: #5b5b5b; width: 100%; margin: 10px 0 10px 0;">
				<tr>
					<td style="border: none; padding: 4px;">Number of categories</td>
					<td style="border: none; padding: 4px;"><b>12</b></td>
				</tr>
				<tr>
					<td style="border: none; padding: 4px;">Current product number</td>
					<td style="border: none; padding: 4px;"><b>12</b></td>
				</tr>
				<tr>
					<td style="border: none; padding: 4px;">Number of photos in
						the gallery</td>
					<td style="border: none; padding: 4px;"><b>12</b></td>
				</tr>
				<tr>
					<td style="border: none; padding: 4px;">Amount of customer
						data</td>
					<td style="border: none; padding: 4px;"><b>12</b></td>
				</tr>
			</table>
